...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			// create the objects  
			Instructor tempInstructor = new Instructor("Touhid", "Jisan", "touhid@gmail.com");
			InstructorDetail tempInstructorDetail = new InstructorDetail("youtube.com/agg", "editing");
